...
var UIController = (function() {
    ...
    var formatNumber = function(num,type) {
            ...
            num = Math.abs(num);
            num = num.toFixed(2); // for decimal to two numbers
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var updatePercentages = function() {
        ...
        //3. update it to the UI with the new percentages
    ...
    ctrlDeleteItem = function(event) {
        ...
        if (itemID) {
            ...
            //inc-1
            splitID = itemID.split('-');//split makes the string to array e.g 'inc-1' -> ['inc','1']
            type = splitID[0];
